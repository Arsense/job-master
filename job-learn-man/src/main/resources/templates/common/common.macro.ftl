...
<#macro commonFooter >
	<footer class="main-footer">
        Powered by <b>JOB-learn</b> ${I18n.admin_version}
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; 2019-${.now?string('yyyy')} &nbsp;
                <a href="http://www.xuxueli.com/" target="_blank" >Arsense</a>
                &nbsp;
                <a href="https://github.com/Arsense/job-master" target="_blank" >github</a>
